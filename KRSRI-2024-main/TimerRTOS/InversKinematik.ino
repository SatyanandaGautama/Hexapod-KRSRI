void FR(float x, float y, float h) {  //Kanan Atas (KUADRANT 2)
  ...
  theta2 = alpha + beta;
  sdtfemur = ((300 - (90 + round((theta2 * 180 / M_PI)))) + rightFM_FR - 3) * 3.41;
  theta3 = acos((tb * tb + fm * fm - c * c) / (2 * tb * fm));
  sdttibia = ((300 - (90 - (round((theta3 * 180 / M_PI) - 90)))) + rightTB - 3) * 3.41;
...
void RM(float x, float y, float h) {  //Kanan Tengah (Kuadrant 2 atau 3)
  ...
  beta = acos((fm * fm + c * c - tb * tb) / (2 * fm * c));
  theta2 = alpha + beta;
  sdtfemur = (((300 - (90 + round((theta2 * 180 / M_PI))))) + midRightFM + 3) * 3.41;  //2

  theta3 = acos((tb * tb + fm * fm - c * c) / (2 * tb * fm));
  sdttibia = (((300 - (90 - (round((theta3 * 180 / M_PI) - 90)))) + midRightTB) - 20) * 3.41;  // terakhir - 13 Kalau servo tibia udah diganti, hapus + 17 nya // diganti
...
void BR(float x, float y, float h) {                 //Kanan Bawah (KUADRANT 3)
  ...
  theta3 = acos((tb * tb + fm * fm - c * c) / (2 * tb * fm));
  sdttibia = (((300 - (90 - (round((theta3 * 180 / M_PI) - 90))))) + rightTB) * 3.41;  //awalnya -17 (lebih buka lagi 14, atur gdi gerak naik tangga juga)
...
void BL(float x, float y, float h) {  //Kiri Bawah (KUADRANT 4)
  ...
  beta = acos((fm * fm + c * c - tb * tb) / (2 * fm * c));
  theta2 = alpha + beta;
  sdtfemur = ((90 + round((theta2 * 180 / M_PI))) + leftFM + 5) * 3.41;  //4

  theta3 = acos((tb * tb + fm * fm - c * c) / (2 * tb * fm));
  sdttibia = (((90 - (round((theta3 * 180 / M_PI) - 90)))) + leftTB - 3) * 3.41;  //Kalau tibia udah diganti pake servo tibianya RM, maka tambahkan - 17 di sebelum leftTB
...
void LM(float x, float y, float h) {  //Kiri Tengah (Kuadrant 1 atau 4)
  ...
  beta = acos((fm * fm + c * c - tb * tb) / (2 * fm * c));
  theta2 = alpha + beta;
  sdtfemur = (((90 + round((theta2 * 180 / M_PI)))) + midLeftFM - 2) * 3.41;  //-2

  theta3 = acos((tb * tb + fm * fm - c * c) / (2 * tb * fm));
  sdttibia = (((90 - (round((theta3 * 180 / M_PI) - 90)))) + midLeftTB) * 3.41;  //Awalnya tidak ditambah 3
...
void FL(float x, float y, float h) {  //Kiri Atas (KUADRANT 1)
  ...
  beta = acos((fm * fm + c * c - tb * tb) / (2 * fm * c));
  theta2 = alpha + beta;
  sdtfemur = ((90 + round((theta2 * 180 / M_PI))) + leftFM_FL) * 3.41;  //2 asli 4
