...
//        xSemaphoreGive(mutex);
//        while (1) {
//          GerakanAfterTangga(5, 20, 5, 20, 39, 24, 0, 0, 0);
...
//          if ((filtered_Roll >= 8) || (steps == 1 || steps == 3)) {
//            break;
//          }
//          xSemaphoreTake(mutex, portMAX_DELAY);
...
//        xSemaphoreGive(mutex);
//     // ==========================//
//     while ((TOFKiri > 26) || (steps == 1 || steps == 3)) {  //Asli 13
//       navigasiMPU_Kiri(22);
//       xSemaphoreTake(mutex, portMAX_DELAY);
//       GerakGeser(22, 37, 34, lebarKiri, lebarKanan, lebarTengah);
//       xSemaphoreGive(mutex);
...
//     while (TOFDepan < 7 || (steps == 1 || steps == 3)) {
//       navigasiMPU_Mundur(15);
//       xSemaphoreTake(mutex, portMAX_DELAY);
...
//       bacaTOFKanan();
//       xSemaphoreGive(mutex);
//       while (TOFKanan < 43 || (steps == 1 || steps == 3)) {  //Asli 22
//         navigasiMPU_Kiri(10);
//         xSemaphoreTake(mutex, portMAX_DELAY);
...
//         xSemaphoreGive(mutex);
//       }
//       while ((TOFKanan > 44) || (steps == 1 || steps == 3)) {  //Asli 26
...
//     bacaTOFBelakang();
//     xSemaphoreGive(mutex);
//     while (TOFBelakang < 15 || (steps == 1 || steps == 3)) {
...
//       bacaTOFKanan();
//       xSemaphoreGive(mutex);
//       while (TOFKanan < 37 || (steps == 1 || steps == 3)) {  //Asli 22
//         navigasiMPU_Kiri(9);
//         xSemaphoreTake(mutex, portMAX_DELAY);
//         GerakGeser(9, 37, 38, lebarKiri, lebarKanan, lebarTengah);
//         xSemaphoreGive(mutex);
...
//         xSemaphoreGive(mutex);
//       }
//       while ((TOFKanan > 38) || (steps == 1 || steps == 3)) {  //Asli 26
//         navigasiMPU_Kanan(9);
//         xSemaphoreTake(mutex, portMAX_DELAY);
//         GerakGeser(-9, 37, 38, lebarKiri, lebarKanan, lebarTengah);
//         xSemaphoreGive(mutex);
